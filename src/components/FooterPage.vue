<template>
    <div>
        ...
        <footer class="p-4 bg-white rounded-lg shadow md:px-6 md:py-8 dark:bg-gray-800">
            ...
            <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" target="_blank"
                    class="hover:underline">QuirkWeb Studios™</a>. All Rights Reserved.
            </span>
        </footer>
    </div>
</template>
